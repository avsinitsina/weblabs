...
$routes->setDefaultController('RapperController');
...
// $routes->get('(:any)', 'RapperController::/$1');
...
$routes->get('matrix2', 'RapperController::matrix2');
$routes->post('matrix2', 'RapperController::matrix2');
$routes->post('form', 'RapperController::matrix');
$routes->post('download', 'RapperController::downloadfile');
$routes->post('upload', 'RapperController::matrix2');
