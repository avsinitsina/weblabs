            ...
            <div class="col-6">
                ...
                <div class="form-group mb-2 pt-4">
                    <select class="form-control" name="dead_baddy" id="genre" value="<?= $rapper['dead_baddy']==='Killed in a fight' ? '1' : '0';?>">
                        <option <?= $rapper['dead_baddy']=='Killed in a fight' ? 'selected' : '';?>>Killed in a fight</option>
                        <option <?= $rapper['dead_baddy']=='Killed in a fight' ? '' : 'selected';?>>Not killed in a fight</option>
                    </select>
                </div>
            </div>
