...
function load_list(result) {
  ...
  result.rappers.forEach(function (item) {
    str = "<tr>\n                <td>".concat(item.name, "</td>\n                <td>").concat(item.genre, "</td>\n                <td>").concat(item.label, "</td>\n                <td>").concat(item.country, "</td>\n                <td>").concat(item.from, "</td>\n                <td>").concat(item.dead_baddy, "</td>\n                <td>").concat(item.cool_moves_count, "</td>\n                <td>").concat(item.swearing_frequency, "</td>\n                <td><button type='button' id=\"").concat(item.id, "\">Delete</button></td>\n                <td><a role='button' class=$(\"btn btn-warning\") href=\"/edit/").concat(item.id, "\">Edit</a></td>\n<!--                onclick=\"deleteRec(").concat(item.id, ")\"-->\n            </tr>");
...
function get_page() {
  var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/list/1';
  $.post(page, {
...
__webpack_require__(/*! D:\OpenServer\domains\Web.Lab4\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\OpenServer\domains\Web.Lab4\resources\css\app.css */"./resources/css/app.css");
